  ...
  const handleInterpret = async () => {
    ...
    try {
      const res = await fetch("/api/dream-oracle", {
        ...
        body: JSON.stringify({
          dreamText: dream,
          userId: "00000000-0000-0000-0000-000000000000", // Replace with actual auth userId later
          tags: selectedTags,
        ...
        >
          ...
          <div className="relative">
            ...
            <button
              ...
              style={{
                backgroundColor: recording ? "rgba(139,0,0,0.2)" : "rgba(42,42,62,0.5)",
                color: recording ? "#8B0000" : "#8A8A9A",
              }}
          ...
          <button
            ...
            style={{
              backgroundColor: loading ? "#2A2A3E" : "#D4AF37",
              color: loading ? "#8A8A9A" : "#0A0A0F",
              fontFamily: "Cinzel, serif",
            }}
          >
            {loading ? (
        ...
        {result && (
          <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-3">
                {result.symbols.map((s, i) => (
                  <div key={i} className="flex gap-3 items-start">
                    ...
                    <span className="text-sm leading-relaxed" style={{ color: "#F5F0E6", fontFamily: "Inter, sans-serif" }}>
                      {s.meaning}
                    </span>
                  </div>
                ))}
            ...
            >
              ...
              <p className="text-sm leading-relaxed whitespace-pre-line" style={{ color: "#F5F0E6", fontFamily: "Inter, sans-serif" }}>
                {result.meaning}
              </p>
            </div>
            ...
            <div
              ...
              style={{
                backgroundColor: "#14141E",
                borderColor: "#2A2A3E",
                borderLeftColor: "#046307",
              }}
            >
              <h3
                className="text-sm font-bold mb-3 tracking-wider"
                style={{ color: "#046307", fontFamily: "Cinzel, serif" }}
              >
                THE MESSAGE
              </h3>
              <p className="text-sm leading-relaxed" style={{ color: "#F5F0E6", fontFamily: "Inter, sans-serif" }}>
                {result.message}
              </p>
            </div>
            ...
            >
              <h3
                className="text-sm font-bold mb-3 tracking-wider"
                style={{ color: "#B87333", fontFamily: "Cinzel, serif" }}
              >
                THE ACTION
              </h3>
              <p className="text-sm leading-relaxed" style={{ color: "#F5F0E6", fontFamily: "Inter, sans-serif" }}>
            ...
            <div
              ...
              style={{
                background: "linear-gradient(135deg, rgba(75,0,130,0.15) 0%, rgba(212,175,55,0.15) 100%)",
                borderColor: "#D4AF37",
              }}
            >
              <h3
            ...
            <div className="flex gap-3">
              <button
                ...
                style={{
                  backgroundColor: saved ? "#046307" : "#04630720",
                  color: saved ? "#F5F0E6" : "#046307",
